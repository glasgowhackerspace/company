...
\begin{document}
  ...
  The suggested membership fee is £25/month. If you are unable to afford the
  suggested fee, please indicate in your email to us what you are able to pay.
  We will never reject members based on membership cost, and there is no
  hierarchy of membership.

  \textbf{Disclaimer:} Your information will be stored for 10 years after the end
  of your membership, in line with UK company law (section 121 of Companies Act
  2006). They will be stored in Proton Drive and accessible only to the company
  directors; or per reasonable request to inspect (section 116 of Companies Act
  2006).

  \footnotetext{Our Articles of Association are available at: https://github.com/glasgowhackerspace/company}
  \footnotetext[1]{Wiki: https://wiki.glashack.space}
  \footnotetext[2]{Health and Safety policy: https://wiki.glashack.space/doku.php?id=about:health-and-safety}
