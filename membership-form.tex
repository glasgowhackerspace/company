...
\begin{document}
  ...
  \begin{Form}
    ...
    \yesno{Have you read and agree to abide by the health and safety policy\footnotemark[1]?}{policy}
  ...
  \footnotetext[1]{Health and Safety policy: https://wiki.glashack.space/doku.php?id=about:health-and-safety}
