...
\renewcommand\contentsname{
    \bfseries\Large{Index to the Articles}\newline
}
...
\subsubsection[Community Interest Company]{\textcolor{red}{The Company is to be a community interest company.}}
...
\subsection{Asset Lock}
  ...
  \subsubsection[Specifics of Full Consideration of Assets]{\textcolor{red}{Provided the conditions in \fancyref{subsubsection:metaassetrestr} are satisfied, \fancyref{subsubsubsection:fullconsideration} shall not apply to:}}\label{subsubsection:transferrestrictions}
  \begin{subindentlist}
